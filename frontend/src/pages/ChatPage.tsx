        ...
        <div className="flex items-center justify-between px-4 sm:px-6 h-16">
          ...
          <div className="flex items-center gap-4">
            ...
            <Button
              ...
              variant="outline"
              size="sm"
              className="hidden lg:flex gap-2 border-border text-foreground hover:bg-red-50 dark:hover:bg-red-950/30 hover:border-red-300 dark:hover:border-red-700 hover:text-red-600 dark:hover:text-red-400 transition-all duration-300 font-sans font-medium"
            >
